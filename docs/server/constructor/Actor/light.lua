...
---Light type enumeration for spawning different light actors
---@class LightType
---@field Point string Point light type
---@field Spot string Spot light type
---@field Rect string Rect light type

---Spawns a new light actor in the world with configurable properties
...
---@param LightTypeParam string @[opt] One of LightType.Spot, LightType.Point, LightType.Rect (default: LightType.Point)
---@param Intensity number @[opt] Light intensity in lumens (default: 5000)
...
---@param InnerConePercent number @[opt] Inner cone percent 0-1, Spot only (default: 0)
...
---@return table Light wrapper with .Object (AActor) and .Component (ULightComponent)
